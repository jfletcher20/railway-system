...
import hr.foi.jfletcher20.enums.TrackCategory;
import hr.foi.jfletcher20.enums.TrackStatusType;
...
public record TrainTrack(String id, // oznaka pruge
    TrackCategory category, // kategorija pruge
    ...
    TrackStatusType status // status pruge
) implements IProduct {
  public TrainTrack {
